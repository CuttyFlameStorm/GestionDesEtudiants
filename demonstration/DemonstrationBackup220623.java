...
public class DemonstrationBackup220623{
	 ...
	 */
	public static void creerTout() throws ClasseException,ParseException {
	...
	public String toString() {
		return "DemonstrationBackup220623 [getClass()=" + getClass() + ", toString()=" + super.toString() + "]";
	}
	 ...
	 */
	public static void main(String[] args) throws ClasseException, ParseException {
		creerTout();
